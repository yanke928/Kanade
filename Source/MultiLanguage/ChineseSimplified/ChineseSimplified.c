{"器",0x04,0x80,0xE4,0xF0,0xA5,0x50,0xA5,0x50,0xE6,0x70,0x1C,0x00,0xE6,0x70,0xA5,0x50,0xB5,0x50,0xEC,0xF0,0x04,0x80,0x00,0x00},/*"器",32*/
{"扫",0x11,0x00,0x11,0x10,0xFF,0xF0,0x12,0x00,0x12,0x00,0x40,0x20,0x44,0x20,0x44,0x20,0x44,0x20,0x44,0x20,0x7F,0xF0,0x00,0x00},/*"扫",33*/
{"描",0x11,0x00,0x11,0x10,0xFF,0xF0,0x12,0x00,0x4F,0xF0,0xE9,0x20,0x49,0x20,0x4F,0xE0,0x49,0x20,0xE9,0x20,0x4F,0xF0,0x00,0x00},/*"描",34*/
{"信",0x08,0x00,0x3F,0xF0,0xC0,0x00,0x20,0x00,0x2A,0xF0,0x2A,0xA0,0xAA,0xA0,0x6A,0xA0,0x2A,0xA0,0x2A,0xF0,0x20,0x00,0x00,0x00},/*"信",35*/
{"息",0x00,0x10,0x7F,0x60,0x55,0x00,0x55,0x60,0xD5,0x10,0x55,0x90,0x55,0x50,0x55,0x10,0x55,0x30,0x7F,0x40,0x00,0x30,0x00,0x00},/*"息",36*/

{"？",0x00,0x00,0x30,0x00,0x70,0x00,0x87,0x60,0x8F,0x60,0x78,0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"？",37*/
};

const GB2312Font16 ChineseSimplifiedTab16[]={
...
{"设",0x02,0x00,0x02,0x00,0x42,0x00,0x33,0xFC,0x00,0x09,0x02,0x11,0x05,0x02,0x79,0xC2,0x41,0x34,0x41,0x08,0x41,0x14,0x79,0x62,0x05,0x82,0x04,0x01,0x04,0x01,0x00,0x00},/*"设",11*/
...
u16 GetChineseSimplifiedAddr(s8 *ptr, u8 size)
{
	u16 addr;
	if (size == 12)
		for (addr = 0; addr < sizeof(ChineseSimplifiedTab12) / sizeof(ChineseSimplifiedTab12[0]) - 1; addr++)
		{
			if ((*ptr == ChineseSimplifiedTab12[addr].Index[0]) && (*(ptr + 1) == ChineseSimplifiedTab12[addr].Index[1]))
			{
				break;
			}
		}
	...
	{
		for (addr = 0; addr < sizeof(ChineseSimplifiedTab16) / sizeof(ChineseSimplifiedTab16[0]) - 1; addr++)
		{
			if ((*ptr == ChineseSimplifiedTab16[addr].Index[0]) && (*(ptr + 1) == ChineseSimplifiedTab16[addr].Index[1]))
			{
				break;
			}
		}	 
