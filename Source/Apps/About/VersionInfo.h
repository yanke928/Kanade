...
const char CustomString_EN[]="Sometimes naive";
const char CustomString_TW[]="Sometimes naive";
const char CustomString_CN[]="Sometimes naive";
const char CustomString_JP[]="Sometimes naive";
