...
{'.',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0E,0x00,0x0E,0x00,0x0E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"未命名文件",0*/
{'C',0x00,0x00,0x1F,0xF8,0x7F,0xFE,0x60,0x06,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xE0,0x07,0x78,0x1E,0x18,0x18,0x00,0x00},/*"未命名文件",0*/
{'a',0x00,0x00,0x06,0x3E,0x0E,0x7F,0x1C,0xE7,0x18,0xC3,0x18,0xC3,0x18,0xC3,0x1C,0xE7,0x0F,0xFF,0x07,0xFF,0x00,0x03,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\a(small).BMP",0*/
{'d',0x00,0x00,0x00,0xFC,0x01,0xFE,0x03,0x87,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x87,0xFF,0xFF,0xFF,0xFE,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\d(small).bmp",0*/
{'e',0x00,0x00,0x01,0xFC,0x03,0xFE,0x07,0x37,0x06,0x33,0x06,0x33,0x06,0x33,0x06,0x33,0x07,0x33,0x03,0xF3,0x01,0xE3,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\e(small).BMP",0*/
{'F',0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xC1,0x80,0xC1,0x80,0xC1,0x80,0xC1,0x80,0xC1,0x80,0xC1,0x80,0xC1,0x80,0xC0,0x00,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\F(big).BMP",0*/
{'h',0x00,0x00,0xFF,0xFF,0xFF,0xFF,0x07,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x07,0x00,0x03,0xFF,0x01,0xFF,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\h(small).BMP",0*/
{'i',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x63,0xFF,0x63,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\i(small).BMP",0*/
{'M',0x00,0x00,0xFF,0xFF,0xFF,0xFF,0x3F,0x80,0x03,0xF0,0x00,0x7F,0x00,0x7F,0x03,0xF0,0x3F,0x80,0xFF,0xFF,0xFF,0xFF,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\M.bmp",0*/
{'n',0x00,0x00,0x07,0xFF,0x07,0xFF,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x07,0x00,0x03,0xFF,0x01,0xFF,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\n(small).bmp",0*/
{'o',0x00,0x00,0x01,0xFC,0x03,0xFE,0x07,0x07,0x06,0x03,0x06,0x03,0x06,0x03,0x06,0x03,0x07,0x07,0x03,0xFE,0x01,0xFC,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\o(small).bmp",0*/
{'r',0x00,0x00,0x00,0x00,0x07,0xFF,0x07,0xFF,0x03,0x00,0x07,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x00,0x00,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\r(small).BMP",0*/
{'S',0x00,0x00,0x3C,0x1C,0x7E,0x1E,0xE6,0x07,0xC3,0x03,0xC3,0x03,0xC1,0x83,0xC1,0x83,0xE0,0xC7,0x78,0xFE,0x38,0x7C,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\S(big).bmp",0*/
{'T',0x00,0x00,0xC0,0x00,0xC0,0x00,0xC0,0x00,0xC0,0x00,0xFF,0xFF,0xFF,0xFF,0xC0,0x00,0xC0,0x00,0xC0,0x00,0xC0,0x00,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\T(Big).bmp",0*/
{'t',0x00,0x00,0x00,0x00,0x03,0x00,0x03,0x00,0x3F,0xFE,0x3F,0xFF,0x03,0x03,0x03,0x03,0x03,0x03,0x00,0x0F,0x00,0x06,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\t(small).BMP",0*/
{'u',0x00,0x00,0x07,0xFC,0x07,0xFE,0x00,0x07,0x00,0x03,0x00,0x03,0x00,0x03,0x00,0x03,0x00,0x03,0x07,0xFF,0x07,0xFF,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\u(small).bmp",0*/
{'W',0x00,0x00,0xFC,0x00,0xFF,0xE0,0x01,0xFF,0x00,0xFF,0xFF,0xE0,0xFF,0xE0,0x00,0xFF,0x01,0xFF,0xFF,0xE0,0xFC,0x00,0x00,0x00},/*"E:\Kanade\Clock Digits\1216\W(Big).BMP",0*/
};
