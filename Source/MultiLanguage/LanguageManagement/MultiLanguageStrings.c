...
const char IvePlugged_Str_EN[] = "I've plugged";
const char IvePlugged_Str_TW[] = "我已接入";
const char IvePlugged_Str_CN[] = "我已接入";
const char IvePlugged_Str_JP[] = "I've plugged";
const char* const IvePlugged_Str[] = { IvePlugged_Str_EN,IvePlugged_Str_TW,IvePlugged_Str_CN,IvePlugged_Str_JP };

const char PlugInLoad_Str_EN[] = "Plug in load";
const char PlugInLoad_Str_TW[] = "請接入負載";
const char PlugInLoad_Str_CN[] = "请接入负载";
